...
export default function YogaGallery({ className = '' }: YogaGalleryProps) {
  const images = [
    ...
    { id: 2, height: 240, offsetY: 20, alt: 'Yoga pose 2', src: '/images/home/yoga-off-2.jpg' },
    { id: 3, height: 320, offsetY: -10, alt: 'Yoga pose 3', src: '/images/home/yoga-off-3.jpg' },
    { id: 4, height: 260, offsetY: 15, alt: 'Yoga pose 4', src: '/images/home/yoga-off-4.jpg' },
